...
- **Understands your documents**: converts PDFs and Office files (`.docx`, `.xlsx`, `.pptx`, plus legacy/OpenDocument variants) to searchable text and analyzes content to create agents specialized in the subject matter
